...
function ControllerElementos(personagem, movimentos) {
  ...
  this.add_inventario = function () {
    ...
    $('#play').on('click', function () {//em menu_game!
      if (EM_JOGO && !EM_PAUSE) {
        ...
        if ($(this).attr('name') == 'pause') {
          ...
          $(this).attr('name', 'play')
          for (let i = 0; i < 17; i++) {//restaura a opacidade da barra
    ...
    for (let i = 0; i < 17; i++) {
      $('#b' + (i + 1)).on('click', function () {
        ...
        if ($('#play').attr('name') != 'pause')//se nao tiver executando!
    ...
    $('#b_cima').on('click', function () {
      ...
      $(quem_chamou_o_menu_supenso).append('<div class="div-aux-image-painel"></div>');
      let bg = $(this).css('background-image');
      bg = bg.replace('url(', '').replace(')', '').replace(/\"/gi, "");//captura a Url da imagem do menu suspenso!
      $(quem_chamou_o_menu_supenso + ' div').css('background-image', 'url(' + bg + ')');
      $('.container-inventario-menu-suspenso').css("visibility", "hidden");
    ...
    $('#b_painel').on('click', function () {
      ...
      $(quem_chamou_o_menu_supenso).text("")
      $(quem_chamou_o_menu_supenso + ' div').remove();//remove qq movimento contido!
      $(quem_chamou_o_menu_supenso).append('<div class="div-aux-image-painel"></div>');//adiciona o novo movimento!
      let bg = $(this).css('background-image');
      bg = bg.replace('url(', '').replace(')', '').replace(/\"/gi, "");
      $(quem_chamou_o_menu_supenso + ' div').css('background-image', 'url(' + bg + ')');
      $('.container-inventario-menu-suspenso').css("visibility", "hidden");
    ...
    //Home
    $('#inventario').append('<div class="container-inventario-card-home"></div>');
    $('.container-inventario-card-home').css('top', 169)
    $('.container-inventario-card-home').css('left', 693)
    // $('.container-inventario-card-cronometro').css('left', 200)
    ...
    $('.item-card-home').on('click', function () {
      var name = confirm("Pressione OK, se desejar voltar ao menu")
      if (name == true) 
  ...
  this.add_alerta_menu_tutorial_p1 = function () {
    ...
    <div class="container-alerta-card-tutorial">\
       ...
       <div class="item-card-tutorial">\
        ...
        <div class="item-card-tutorial">\
        <button class="btn-pular-item-tutorial aux-btn-card-tutorial">Pular intro</button>\
  </div>\
    </div>');
  ...
  this.add_alerta_menu_tutorial_p2 = function () {
    ...
    <div class="container-alerta-card-tutorial">\
        ...
        <div class="card-botoes">\
          <div class="item-card-tutorial">\
            <button class="btn-voltar-item-tutorial aux-btn-card-tutorial">&lt;</button>\
          </div>\
          <div class="item-card-tutorial">\
            <button class="btn-proximo-item-tutorial aux-btn-card-tutorial">&gt;</button>\
          </div>\
  ...
  this.add_alerta_menu_tutorial_p4 = function () {
    ...
    $(".alerta-container").append('\
    <div class="container-alerta-card-tutorial">\
        <div class="titulo-card-tutorial">Utilize a barra de comandos para executar os movimentos do jogo <br> <img   width="80%" height="40px" src = "../assets/barra_comandos.png" alt="barra de comandos"><br> Aperte o botão  <img   width="40px" height="30px" src = "../assets/play.png" alt="play"> quando estiver pronto!<br> </div>\
        <div class="card-botoes">\
        <div class="item-card-tutorial">\
          <button class="btn-voltar-item-tutorial aux-btn-card-tutorial">&lt;</button>\
        </div>\
  ...
  this.add_alerta_menu_tutorial_p6 = function () {
    ...
    $(".alerta-container").append('\
    <div class="container-alerta-card-tutorial">\
        <div class="titulo-card-tutorial">Ao clicar em algum quadrado/número, um menu de movimentos poderá ser visualizado na tela <br> <img width="80%" height="80px" src = "../assets/comandos_explicacao.jpg" alt="Menu de movimentos"><br></div>\
        <div class="card-botoes">\
        <div class="item-card-tutorial">\
          <button class="btn-voltar-item-tutorial aux-btn-card-tutorial">&lt;</button>\
        </div>\
  ...
  this.add_alerta_menu_tutorial_p7 = function () {
    ...
    $(".alerta-container").append('\
    <div class="container-alerta-card-tutorial">\
        <div class="titulo-card-tutorial"> Os movimentos são: <br> <b class="exemplo-comandos-tutorial"><img width="20px" height="20px" src = "../assets/seta_direita.png" alt="play">: Mover o personagem uma casa para direita</b>\
        <br> <b class="exemplo-comandos-tutorial"><img width="20px" height="20px" src = "../assets/seta_esquerda.png" alt="esquerda">: Mover o personagem uma casa para esquerda</b><br>\
        <b class="exemplo-comandos-tutorial"><img width="30px" height="20px" src = "../assets/seta_cima.png" alt="cima">: Mover o personagem uma casa para cima</b>\
        <br><b class="exemplo-comandos-tutorial"><img width="30px" height="20px" src = "../assets/seta_baixo.png" alt="baixo">: Mover o personagem uma casa para baixo</b><br>\
       </div>\
       <div class="card-botoes">\
       <div class="item-card-tutorial">\
         <button class="btn-voltar-item-tutorial aux-btn-card-tutorial">&lt;</button>\
  ...
  this.add_alerta_menu_tutorial_p8 = function () {
    ...
    $(".alerta-container").append('\
    <div class="container-alerta-card-tutorial">\
        <div class="titulo-card-tutorial"> Outros Movimentos: <br>\
        <b class="exemplo-comandos-tutorial"><img width="30px" height="20px" src = "../assets/comando_painel.png" alt="alavanca">: Abrir/Fechar barreira</b>\
        <br><b class="exemplo-comandos-tutorial"><img width="60px" height="30px" src = "../assets/tunel.png" alt="tunel">: Entrar/Sair Túnel</b>\
        <br><b class="exemplo-comandos-tutorial"><img width="20px" height="20px" src = "../assets/remover.png" alt="play">: Remover um comando</b>\
        <br><b class="exemplo-comandos-tutorial"> Limpar tudo: Remover todos os comandos</b>\
        </div>\
       <div class="card-botoes">\
       <div class="item-card-tutorial">\
         <button class="btn-voltar-item-tutorial aux-btn-card-tutorial">&lt;</button>\
    ...
    // </div>\
    $(".btn-proximo-item-tutorial").on("click", function (params) {
      new ControllerElementos().add_alerta_menu_tutorial_p9() //ficou sem contexto!
    });
    $(".btn-voltar-item-tutorial").on("click", function (params) {
      new ControllerElementos().add_alerta_menu_tutorial_p7() //ficou sem contexto!
    });
  ...
  this.add_alerta_menu_tutorial_p9 = function () {
    $('.alerta-container').remove();
    $("#frame").append('<div class="alerta-container motionL"></div>');
    $(".alerta-container").append('<span></span><span></span><span></span><span></span>');
    // $(".alerta-container").append('<div class="alerta-container-close">X</div>');
    ...
    <div class="container-alerta-card-tutorial">\
        ...
        <br><b class="exemplo-comandos-tutorial">Existir uma colisão entre o trem e o veículo</b>\
        <br><b class="exemplo-comandos-tutorial">Não cumprir o objetivo durante a execução</b>\
        <br><b class="exemplo-comandos-tutorial">Executar erroneamente os movimentos:</b>\
  ...
  this.add_alerta_menu_tutorial_final = function () {
    ...
    $(".alerta-container").append('\
    <div class="container-alerta-card-tutorial">\
        <div class="titulo-card-tutorial">Fique atento ao relógio do jogo <b class="titulo-span-tutorial">(Hora atual)</b> e ao relógio que notifica o horário do trem vir <b class="titulo-span-tutorial">(Hora do Trem vir)</b><br> Bom jogo!<br><br></div>\
        <div class="card-botoes">\
          <div class="item-card-tutorial">\
  ...
  this.add_alerta_proxima_fase = function (nova_fase) {
    ...
    $(".alerta-container").append('\
    <div class="container-alerta-card-tutorial">\
        <div class="titulo-card-tutorial"> Você finalizou essa fase, avance para próxima! <br><br> <b class="titulo-span-tutorial">Fase de nº '+ nova_fase + '/3</b></div>\
        <br>\
        <div class="card-botoes">\
        <div class="item-card-tutorial">\
          <button class="btn-proximo-item-tutorial aux-btn-card-tutorial">Jogar</button>\
  ...
  this.add_alerta_ganhou_jogo = function (cronometro, tempoExtra) {
    ...
    <div class="container-alerta-card-tutorial">\
        <div class="titulo-card-tutorial"><b class="titulo-span-tutorial">Parabéns, Você venceu!</b><br><br>\
         ...
         TEMPO FINAL:<b class="titulo-span-tutorial"> '+ cronometroAux.get_tempo() + '</b></div><br>\
        <div class="card-botoes">\
          <div class="item-card-tutorial">\
            <button class="btn-proximo-item-tutorial aux-btn-card-tutorial">Menu</button>\
          </div>\
        </div>\
    </div>');
    //     <div class="item-card-sair-jogo">\
